          ...
          <div className="flex flex-col mt-10 min-w-[860px]">
            <div className="flex mb-10">
              <div className="flex items-center justify-end min-w-[190px] mr-12 h-8">
                <span className="text-right text-xl font-bold text-default">
                  サムネイル:
                </span>
              </div>
              <div className="flex flex-col">
                {selectedImage === null && (
                  <div>
                    <label
                      className="inline-block w-fit z-10"
                      htmlFor="imageInput"
                    >
                      <div
            ...
            <div className="flex mb-10">
              <div className="flex items-center justify-end min-w-[190px] mr-12 h-8">
                <span className="text-xl text-default">大学名 (略称)</span>
            ...
            <div className="flex mb-10">
              <div className="flex items-center justify-end min-w-[190px] mr-12 h-8">
                <span className="text-xl text-default">大学名</span>
                <span className="text-danger text-xl">*</span>
                <span className="text-xl text-default">:</span>
              </div>
              <Form.Item
              ...
              >
                <Input className="w-[400px] text-lg" placeholder="大学名" maxLength={64}/>
              </Form.Item>
            </div>
              ...
              {items.map((item, index) => {
                return (
                  <div className="flex mb-8" key={item.id}>
                    <div className="flex items-center justify-end min-w-[190px] mr-12 h-8">
                      <span className="text-xl text-default">年度コード:</span>
                    </div>
                    ...
                    <div className="flex">
                      <div className="flex items-center justify-end min-w-[200px] mr-12 h-8">
                        <span className="text-xl text-default">入学年度 </span>
                        <span className="text-danger text-xl">*</span>
                        <span className="text-xl text-default">:</span>
                      </div>
                      <Form.Item

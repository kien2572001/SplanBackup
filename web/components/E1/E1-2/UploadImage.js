...
const UploadAvatar = ({ formData, setFormData, submittedForm }) => {
  ...
  return (
    <div className="flex flex-col relative items-center">
      ...
      >
        ...
        sm:w-[133px] sm:h-[133px] bg-gray-100">
          {imgLoading ? (
            <LoadingOutlined />
          ) : (
            ...
            <img
              ...
              src={
                ...
                formData.avatar.preview :
                formData?.avatar ?
                  ((formData.avatar.startsWith("images/") ? "/" : "") +
                    formData.avatar) :
                DefaultAvatar.src
              }
            />
        ...
        {(formData?.avatar?.preview || formData?.avatar) && showDeleteBtn && (
          <div className="flex justify-center items-center rounded-full w-[133px] h-[133px] bg-neutral-900/40 absolute top-0 z-10">
            <DeleteOutlined
      ...
      <div className="mt-4 w-[160px] text-center">
        <Upload
          name="avatar"
        ...
        >
          <Button type="fill" htmlType="button">

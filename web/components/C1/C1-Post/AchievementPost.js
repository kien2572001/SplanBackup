...
const AchievementPost = React.forwardRef((props, ref) => {
  return (
    <Post ref={ref} {...props} >
      <div className="achieve-content flex flex-col justify-center">
        {props.success ? <SuccessMsg {...props} /> : <FailedMsg {...props} />}
        {props.isShowDetail ? (
          <div className="flex gap-1 flex-col 2xl:flex-row 2xl:gap-10 lg:justify-center mt-4">
            <div className="plan flex flex-col self-center">
              <h4 className="text-default font-medium text-center mb-1">
                目標
              </h4>
              {props.subPosts
              ...
              {props.subPosts
                ...
                .map((subPost, index) => (
                  <div key={subPost.id} className="flex">
                    <TestScore
                      type={
                        subPost.achievedScore >= subPost.expectedScore
                          ? "success"
                          : "failed"
                      }
          ...
          <Link
            href={{
              pathname: `/naitei/${props.naiteiId}/posts/${props.id}`,
...
AchievementPost.propTypes = {
  ...
  naiteiId: PropTypes.number.isRequired,
